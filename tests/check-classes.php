...
$file = __DIR__ . '/../core/class/dahuavtobe.class.php';
...
if (!preg_match('/class\s+dahuavtobeCmd\s+extends\s+cmd/', $source)) {
    $problems[] = 'Classe dahuavtobeCmd absente — impossible de créer un équipement.';
}
